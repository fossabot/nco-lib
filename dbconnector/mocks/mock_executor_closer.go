...
func (_m *MockExecutorCloser) Exec(ctx context.Context, query dbconnector.Query) (dbconnector.RowSet, int, error) {
	...
	var r0 dbconnector.RowSet
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, dbconnector.Query) (dbconnector.RowSet, int, error)); ok {
		return rf(ctx, query)
	}
	if rf, ok := ret.Get(0).(func(context.Context, dbconnector.Query) dbconnector.RowSet); ok {
		r0 = rf(ctx, query)
	} else {
		r0 = ret.Get(0).(dbconnector.RowSet)
	}

	if rf, ok := ret.Get(1).(func(context.Context, dbconnector.Query) int); ok {
		r1 = rf(ctx, query)
	} else {
		r1 = ret.Get(1).(int)
	}

	if rf, ok := ret.Get(2).(func(context.Context, dbconnector.Query) error); ok {
		r2 = rf(ctx, query)
	} else {
		r2 = ret.Error(2)
	}
...
func (_c *MockExecutorCloser_Exec_Call) Run(run func(ctx context.Context, query dbconnector.Query)) *MockExecutorCloser_Exec_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(dbconnector.Query))
	})
	return _c
}

func (_c *MockExecutorCloser_Exec_Call) Return(rows dbconnector.RowSet, affectedRows int, err error) *MockExecutorCloser_Exec_Call {
	_c.Call.Return(rows, affectedRows, err)
	return _c
}

func (_c *MockExecutorCloser_Exec_Call) RunAndReturn(run func(context.Context, dbconnector.Query) (dbconnector.RowSet, int, error)) *MockExecutorCloser_Exec_Call {
	_c.Call.Return(run)
	return _c
}
